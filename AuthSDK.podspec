Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "ihsankhaniosdeveloper"
  # spec.authors            = { "ihsankhaniosdeveloper" => "ihsankhaniosdeveloper@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/ihsankhaniosdeveloper"
  ...
  spec.exclude_files = "AuthSDK/Exclude"
